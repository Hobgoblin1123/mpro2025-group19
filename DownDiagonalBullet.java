...
public class DownDiagonalBullet extends Bullet {
    ...
    public DownDiagonalBullet(Player owner, int x, int y, float speed, int radius, int damage, int Shootdir,
            Color color) {
    ...
    // クライアント用のコンストラクタ
    public DownDiagonalBullet(int x, int y, int radius, Color color, int Shootdir, int state_explosion,
            int AnimationFrames) {
