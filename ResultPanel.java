...
public class ResultPanel extends JPanel implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == retryButton) {
            ...
            retryButton.setText("WAITING...");
            System.out.println("リトライボタンが押されました");
            f.tryRetry(); // GameFrameのリトライ処理呼び出し
        } else if (e.getSource() == quitButton) {
            // タイトルへ戻る、または終了
            System.out.println("QUITボタンが押されました");
            // f.backToStart(); // タイトルに戻る場合
            System.exit(0);     // アプリを終了する場合
        }
    }
}